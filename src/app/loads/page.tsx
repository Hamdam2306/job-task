...
export default function LoadDetailPage() {
    ...
    // Yangi yuk qo'shish modal uchun state
    ...
    async function addLoad(data: Omit<Load, 'id' | 'collectionId' | 'collectionName' | 'created' | 'updated'>) {
        try {
            ...
            fetchLoad(); // Yuk qo'shilgandan keyin ro'yxatni yangilash
        } catch (error) {
...
// Yangi yuk qo'shish modal handler-lari
